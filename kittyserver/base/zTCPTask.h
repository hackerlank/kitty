...
class zTCPTask : public zProcessor, private zNoncopyable
{
	...
	public:
		 ...
		 * \return 检测是否成功
		 */
		bool checkVerifyTimeout(const zRTime &ct, const unsigned long long interval = 5000) const
		{
		...
		virtual bool sendCmd(const void *,const DWORD);
		bool sendCmdNoPack(const void *,const DWORD);
