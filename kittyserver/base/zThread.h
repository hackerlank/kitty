/**
 * \file
 * \version  $Id: zThread.h 13 2013-03-20 02:35:18Z  $
 * \author  ,@163.com
 * \date 2004年11月08日 15时22分18秒 CST
 * \brief 定义类zThread
 *
 * 
 */
...
class zThread : private zNoncopyable
{
	...
	public:
		...
		zThread(const std::string &name = std::string("zThread"), const bool joinable = true) 
			: threadName(name), alive(false), complete(false), threadid(0), joinable(joinable) {};
		...
		{
			return pthread_equal(threadid, other.threadid) != 0;
		}
